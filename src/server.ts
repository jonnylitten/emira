...
server.tool(
  "screenshot_mark",
  "Take a screenshot of the current page and return it with numbered labels over every interactive element. Always call before click_label / type_at_label — the label map is rebuilt each call and stale after any DOM change. Use `region` to zoom into a dense part of the page.",
  {
    url: z
      .string()
      .url()
...
server.tool(
  "click_label",
  "Click the element with the given label number from the most recent screenshot_mark call.",
...
server.tool(
  "find_label",
  "Rank labels from the most recent screenshot by how well they match a natural-language description. Returns top matches with scores. Use to pick a target by description ('the Submit button') without re-screenshotting. Returns empty if no element matches.",
  {
